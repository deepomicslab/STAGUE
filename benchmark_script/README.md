The deep learning (DL) baseline methods, including
[DeepLinc](https://github.com/xryanglab/DeepLinc),
[stLearn](https://stlearn.readthedocs.io/en/latest/tutorials/stSME_clustering.html),
...
employed a variety of unsupervised clustering algorithms to cluster the learned cell embeddings, 
